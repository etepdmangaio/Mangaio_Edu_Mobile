...
class QuizController:
    ...
    def cadastrar_respostas(self, usuario_id, quiz_id,pergunta, resposta, acertou, categoria):
        #print('Tentando inserir: ', usuario_id, quiz_id, resposta, acertou, categoria)
        self.db.registrar_resposta(usuario_id, quiz_id, pergunta, resposta, acertou, categoria)
        #st.success("Respostas enviadas com sucesso!")